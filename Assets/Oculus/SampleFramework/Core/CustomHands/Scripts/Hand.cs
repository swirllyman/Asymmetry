...
namespace OVRTouchSample
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        [SerializeField]
        protected HandPose m_defaultGrabPose = null;
        ...
        protected int m_animLayerIndexThumb = -1;
        protected int m_animLayerIndexPoint = -1;
        protected int m_animParamIndexFlex = -1;
        protected int m_animParamIndexPose = -1;

        protected bool m_isPointing = false;
        protected bool m_isGivingThumbsUp = false;
        protected float m_pointBlend = 0.0f;
        protected float m_thumbsUpBlend = 0.0f;
